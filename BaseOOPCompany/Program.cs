...
namespace BaseOOPCompany
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Designer designer1 = new Designer("Des1", "Designer1", 600, 1, 0.5m, manager1);
            Designer designer2 = new Designer("Des2", "Designer2", 900, 2, 0.8m, manager1);
            Designer designer3 = new Designer("Des3", "Designer3", 1200, 2, 0.7m, manager1);
            Designer designer4 = new Designer("Des4", "Designer4", 1700, 3, 0.6m, manager1);
            ...
            Designer designer7 = new Designer("Des7", "Designer7", 1300, 2, 0.65m, manager3);
            Designer designer8 = new Designer("Des8", "Designer8", 700, 1, 0.8m, manager3);
            Designer designer9 = new Designer("Des9", "Designer9", 1200, 2, 0.95m, manager3);
